...
public class AutenticacaoController {
	...
	@PostMapping
	public ResponseEntity<?> autenticar(@RequestBody LoginForm form) throws Exception{
		if(form.getEmail() == null || form.getSenha() == null || form.getEmail().isEmpty() || form.getSenha().isEmpty()) {
